...
namespace POS {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductRow AddProductRow(string ProductName, string Description, decimal Price, int QuantityAvailable, string Barcode) {
        ...
        public partial class ProductRow : global::System.Data.DataRow {
            ...
            public int QuantityAvailable {
                get {
                    return ((int)(this[this.tableProduct.QuantityAvailableColumn]));
                }
                set {
                    this[this.tableProduct.QuantityAvailableColumn] = value;
                }
            }
...
namespace POS.Database1DataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Product] ([ProductName], [Description], [Price], [QuantityAvailable], [Barcode]) VALUES (@ProductName, @Description, @Price, @QuantityAvailable, @Barcode);
SELECT ProductID, ProductName, Description, Price, QuantityAvailable, Barcode FROM Product WHERE (ProductID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [ProductName] = @ProductName, [Description] = @Description, [Price] = @Price, [QuantityAvailable] = @QuantityAvailable, [Barcode] = @Barcode WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)) AND ([Price] = @Original_Price) AND ([QuantityAvailable] = @Original_QuantityAvailable) AND ([Barcode] = @Original_Barcode));
SELECT ProductID, ProductName, Description, Price, QuantityAvailable, Barcode FROM Product WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::POS.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, Description, Price, QuantityAvailable, Barcode FRO" +
                "M dbo.Product";
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, string Original_Description, decimal Original_Price, int Original_QuantityAvailable, string Original_Barcode) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_QuantityAvailable));
        ...
        public virtual int Insert(string ProductName, string Description, decimal Price, int QuantityAvailable, string Barcode) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, string Description, decimal Price, int QuantityAvailable, string Barcode, int Original_ProductID, string Original_ProductName, string Original_Description, decimal Original_Price, int Original_QuantityAvailable, string Original_Barcode, int ProductID) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_QuantityAvailable));
            if ((Original_Barcode == null)) {
                throw new global::System.ArgumentNullException("Original_Barcode");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string Description, decimal Price, int QuantityAvailable, string Barcode, int Original_ProductID, string Original_ProductName, string Original_Description, decimal Original_Price, int Original_QuantityAvailable, string Original_Barcode) {
            return this.Update(ProductName, Description, Price, QuantityAvailable, Barcode, Original_ProductID, Original_ProductName, Original_Description, Original_Price, Original_QuantityAvailable, Original_Barcode, Original_ProductID);
        }
    }
